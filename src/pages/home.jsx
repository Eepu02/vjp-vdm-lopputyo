        ...
        <Layout className="" >
            <div className="flex flex-col justify-between md:flex-row lg:flex-row ">
                <div className="flex-col pl-16 lg:pl-24 w-full lg:w-1/2 md:w-1/2 md:pl-16 md:h-full">
                    <h1 className="pt-12 ml-4 mr-4 lg:pt-24 md:pt-24 lg:pl-10 font-urbanist text-4xl lg:text-6xl text-white vertical-line">
                        Tunteet ovat sokeita sukupuolelle
                    </h1>
                    <p className="pt-8 md:pt-16 pl-4 pr-4 lg:pt-60 lg:pl-12 font-roboto text-base lg:text-lg text-white mr-8 ">
                ...
                <div className="w-full lg:w-1/2 md:w-1/2 md:pr-0 md:pt-48">
                    <img className=" h-auto" src={Man} alt="man" />
                </div>
            </div>
